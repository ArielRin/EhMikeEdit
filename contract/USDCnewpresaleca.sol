...
contract WSM20BabyDogePresale {
    ...
    address public USDTAddress = 0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913;  // Now uses usdc
    ...
    uint256 public totalTokens; // Total supply of presale token frontend metrics
    uint256 public tokensToRelease = 100; // Default: 100% tokens released after presale
    uint256 public ownerBoostedContribution = 0; // Default: 0 USD boost frontend metrics
    uint256 public presalePercentage = 100; // Default: 80% for presale frontend metrics
    uint256 public presaleEndDate; // UNIX timestamp for presale end date frontend metrics
